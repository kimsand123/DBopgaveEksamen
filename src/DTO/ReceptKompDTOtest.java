...
public class ReceptKompDTOtest
{
	...
	String raavareNavn;			// Er ikke essentiel for oprettelse, eksisterer for brugervenlighed
	
	public ReceptKompDTOtest(int receptId, String raavareNavn, int raavareId, double nomNetto, double tolerance)
	{
